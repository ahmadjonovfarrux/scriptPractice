...
// function timeCalculator(minute) {
//   return minute * 60;
// }
// console.log(timeCalculator(5));
...
// function triangle(asos, balandlik){
...
// 6.Quyidagi namunalarga muvofiq ravishda funksiyani tana qismini yozing. kub(3) ➞ 27
...
// function yuziniTopish(boyi, eni) {
//   return boyi * eni;
// }
// console.log(yuziniTopish(4, 5));
...
// function addingString(a) {
//   return "something " + a;
// }
// console.log(addingString("is better than nothing"));
...
// function findingInerSquare(n) {
//   return (n - 2) * 180;
// }
// console.log(findingInerSquare(4));
...
//   }
// }
// console.log(addingNumber(32, 27));
...
// function legsCalculater(tovuq, qoy, sigir) {
//   return tovuq * 2 + qoy * 4 + sigir * 4;
// }
// console.log(legsCalculater(2, 3, 5));
...
// function testingOperator(son1, son2) {
//   if (son1 > 0 && son2 <= 0) {
//     return true;
//   } else {
//     return false;
//   }
// }
// console.log(testingOperator(2, -1));
...
// fun(4) ➞ false
// let counter = 0;
// function tubSonlar(a) {

//     if(a % )
// }
// console.log(tubSonlar(4));
...
// function checkingEquality(x, y) {
//   if ((Number(x) && Boolean(y)) || (Number(y) && Boolean(x))) {
//     console.log(false);
//   } else if ((Number(x) && String(y)) || (Number(y) && String(x))) {
//     console.log(false);
//   } else if ((Number(x) && Number(y)) || (Number(y) && Number(x))) {
//     console.log(true);
//   }
// }
// checkingEquality(2, true);

// 28.Funksiya boolean qiymat qabul qiladi. Ushbu funksiya boolean qiymatni stringga o’girib qaytarib bersin.
// function stringedBool(bool) {
//   return String(bool);
// }
// console.log(stringedBool(true));
...
// function equalingTen(son1, son2) {
